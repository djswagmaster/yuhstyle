...
import yourmod.cards.*;
import yourmod.relics.DreamerItem;

import java.util.ArrayList;

import static yourmod.CharacterFile.Enums.DREAMER_COLOR;
...
public class CharacterFile extends CustomPlayer {
    ...
    public ArrayList<String> getStartingDeck() {
        ...
        retVal.add(Ruminate.ID);
        retVal.add(Flicker.ID);
        retVal.add(DreamBlade.ID);
        return retVal;
    }

    public ArrayList<String> getStartingRelics() {
        ArrayList<String> retVal = new ArrayList<>();
        retVal.add(DreamerItem.ID);
        return retVal;
    }
    ...
    public static class Enums {
        //DREAMER: Change these.
        @SpireEnum
        public static AbstractPlayer.PlayerClass THE_DREAMER;
        @SpireEnum(name = "DREAMER_COLOR")
        public static AbstractCard.CardColor DREAMER_COLOR;
        @SpireEnum(name = "DREAMER_COLOR")
