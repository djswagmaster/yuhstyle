...
public class Wiz {
    ...
    public static AbstractGameAction actionify(Runnable dreamer) {
    ...
    public static void actB(Runnable dreamer) {
        atb(actionify(dreamer));
    }

    public static void actT(Runnable dreamer) {
        att(actionify(dreamer));
    }
