...
public class PermanencePower extends AbstractEasyPower {
    public static String POWER_ID = makeID("PermanencePower");
    private static final PowerStrings powerStrings = CardCrawlGame.languagePack.getPowerStrings(POWER_ID);

    public PermanencePower(AbstractCreature owner, int amount) {
