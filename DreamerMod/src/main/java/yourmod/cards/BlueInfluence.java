...
public class BlueInfluence extends AbstractEasyCard {
    public final static String ID = makeID("BlueInfluence");

    public BlueInfluence() {
    ...
    public void use(AbstractPlayer p, AbstractMonster m) {
        atb(new ChooseColorCardAction(AbstractCard.CardColor.BLUE, 3));
