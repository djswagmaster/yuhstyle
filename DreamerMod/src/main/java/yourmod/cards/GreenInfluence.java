...
public class GreenInfluence extends AbstractEasyCard {
    public final static String ID = makeID("GreenInfluence");

    public GreenInfluence() {
    ...
    public void use(AbstractPlayer p, AbstractMonster m) {
        atb(new ChooseColorCardAction(AbstractCard.CardColor.GREEN, 3));
