...
public class PurpleInfluence extends AbstractEasyCard {
    public final static String ID = makeID("PurpleInfluence");

    public PurpleInfluence() {
    ...
    public void use(AbstractPlayer p, AbstractMonster m) {
        atb(new ChooseColorCardAction(AbstractCard.CardColor.PURPLE, 3));
