...
public class ModFile implements
    ...
    public static Color characterColor = new Color(255, 0, 185, 1); // This should be changed eventually
    ...
    public ModFile() {
        ...
        BaseMod.addColor(CharacterFile.Enums.DREAMER_COLOR, characterColor, characterColor, characterColor,
